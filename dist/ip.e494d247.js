...
var ipComponent = function ipComponent(data) {
  ...
  h3Item.textContent = "IP: ".concat(data.sorgu);
  cardItem2.append(h3Item);
  var pItem = document.createElement("p");
  pItem.setAttribute("class", "ulke");
  pItem.textContent = "".concat(data.ülke, "(").concat(data.ülkeKodu, ")");
  cardItem2.append(pItem);
  var pItem2 = document.createElement("p");
  pItem2.textContent = "Enlem: ".concat(data.enlem, " Boylam: ").concat(data.boylam);
  cardItem2.append(pItem2);
  var pItem3 = document.createElement("p");
  pItem3.textContent = "\u015Eehir: ".concat(data.şehir);
  cardItem2.append(pItem3);
  var pItem4 = document.createElement("p");
  pItem4.textContent = "Saat Dilimi: ".concat(data.saatdilimi);
  cardItem2.append(pItem4);
  var pItem5 = document.createElement("p");
  pItem5.textContent = "Para Birimi: ".concat(data.parabirimi);
  cardItem2.append(pItem5);
  var pItem6 = document.createElement("p");
  pItem6.textContent = "ISP: ".concat(data.isp);
